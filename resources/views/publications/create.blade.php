      ...
      <div style="width:600px;" class="bg-white p-5 rounded">
        ...
        <form method="POST" action="{{route('publications.store')}}" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="titre" name="titre" placeholder="Title..." value="{{old('titre')}}">
            @error('titre')
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="body" name="body" placeholder="Description..." 
          ...
          <div class="form-group">
            <button class="btn btn-dark mt-4 rounded-0 px-5 py-3 form-control">Create New Post</button>
          </div>
        </form>
      </div>
  </div>  
