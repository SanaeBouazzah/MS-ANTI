...
<x-master>
  <div class="flex justify-center items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
      <div style="width:700px;" class="bg-white p-5 rounded">
        <h2 class="text-center mb-3 h2">Inscription in MS-ANTI</h2>
        <form method="POST" action="{{route('profiles.store')}}">
          ...
          <div class="form-group">
            <button class="btn btn-dark mt-4 rounded-0 px-5 py-3 form-control">Create</button>
          </div>
        </form>
      </div>
  </div>  
